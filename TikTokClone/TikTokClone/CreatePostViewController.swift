...
class CreatePostViewController: UIViewController {
    ...
    @IBOutlet weak var beatyLabel: UILabel!
    ...
    func setupView() {
        ...
        timerCounterLabel.backgroundColor = .black.withAlphaComponent(0.42)
        timerCounterLabel.layer.cornerRadius = 15
        timerCounterLabel.layer.borderColor = UIColor.white.cgColor
        timerCounterLabel.layer.borderWidth = 1.8
        timerCounterLabel.clipsToBounds = true
